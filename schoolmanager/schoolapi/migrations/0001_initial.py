# Generated by Django 3.2.9 on 2021-11-13 06:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schoolapi.class')),
                ('username', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schoolapi.instructor')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schoolapi.exam')),
            ],
        ),
        migrations.AddField(
            model_name='exam',
            name='username',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schoolapi.instructor'),
        ),
        migrations.CreateModel(
            name='Event',
            fields=[
